 ...
 */
data class SendEmailEvent(val toEmail: String, val subject: String?, val content: String?, val format: MailFormat, val transactionPhase: TransactionPhase, val attachments: List<EmailAttachment>?)