...
@Suppress ("UNUSED")
class MigrateDeprecatedFieldProperties2 : AbstractAuthzCustomChange() {
        ...
        readMetaforms(connection = connection, ignoreUnknownProperties = true).forEach {
            ...
            metaform.get("sections").forEach { section ->
                ...
                section["fields"].forEach { field ->
                    ...
                    newField.remove("sourceUrl")
                    newField.remove("uploadUrl")
                    newField.remove("singleFile")
                    newField.remove("onlyImages")
                    newField.remove("maxFileSize")
