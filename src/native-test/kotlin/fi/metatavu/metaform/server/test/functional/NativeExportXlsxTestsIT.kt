...
import fi.metatavu.metaform.server.test.functional.tests.ExportXlsxTestsIT
...
/**
 * Native tests for ExportSlsx API
 */
...
class NativeExportXlsxTestsIT: ExportXlsxTestsIT() {
}