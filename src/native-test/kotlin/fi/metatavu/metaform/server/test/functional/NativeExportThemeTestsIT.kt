...
import fi.metatavu.metaform.server.test.functional.tests.ExportThemeTestsIT
...
/**
 * Native tests for ExportThemes API
 */
...
class NativeExportThemeTestsIT: ExportThemeTestsIT() {
}