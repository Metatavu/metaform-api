...
public class MetaformVersionTestBuilderResource extends ApiTestBuilderResource<MetaformVersion, VersionsApi> {
    ...
    @Override
    public void clean(MetaformVersion metaformVersion) {
     ...
     */
     public MetaformVersion create(UUID metaformId, MetaformVersion payload) {
     ...
     */
    public MetaformVersion findVersion(UUID metaformId, UUID versionId) {
     ...
     */
    public void delete(UUID metaformId, MetaformVersion metaformVersion) {
     ...
     */
    public void assertCount(UUID metaformId, int expected) {
     ...
     * @param versionId version id
     */
    public void assertFindFailStatus(int expectedStatus, UUID metaformId, UUID versionId) {
        try {
     ...
     * @param payload payload
     */
    public void assertCreateFailStatus(int expectedStatus, UUID metaformId, MetaformVersion payload) {
        try {
     ...
     * @param versionId version id
     */
    public void assertDeleteFailStatus(int expectedStatus, UUID metaformId, UUID versionId) {
        try {
     ...
     * @param metaformId metaform id
     */
    public void assertListFailStatus(int expectedStatus, UUID metaformId) {
        try {
