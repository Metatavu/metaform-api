...
public class ExportThemeTestBuilderResource extends ApiTestBuilderResource<ExportTheme, ExportThemesApi> {
  ...
  @Override
  public void clean(ExportTheme exportTheme) throws IOException {
   ...
   */
  public ExportTheme findExportTheme(UUID exportThemeId) throws IOException {
   ...
   */
  public List<ExportTheme> listExportThemes() throws IOException {
   ...
   */
  public ExportTheme updateExportTheme(UUID exportThemeId, ExportTheme exportTheme) throws IOException {
   ...
   */
  public void deleteExportTheme(ExportTheme exportTheme) throws IOException {
   ...
   * @param exportThemeId exportThemeId
   */
  public void assertSearchFailStatus(int status, UUID exportThemeId) throws IOException {
    try {
   ...
   * @param exportTheme exportTheme
   */
  public void assertCreateFailStatus(int status, ExportTheme exportTheme) throws IOException {
    try {
   ...
   * @param status expected status
   */
  public void assertListFailStatus(int status) throws IOException {
    try {
   ...
   */
  public void assertUpdateFailStatus(int status, UUID exportThemeId, ExportTheme exportTheme) throws IOException {
    try {
   ...
   * @param exportThemeId export theme id
   */
  public void assertDeleteFailStatus(int status, UUID exportThemeId) throws IOException {
    try {
