...
public class DraftTestBuilderResource extends ApiTestBuilderResource<Draft, DraftsApi> {
   ...
   */
  public Draft updateDraft(UUID metaformId, UUID draftId, Draft draft) throws IOException {
   ...
   * @return found draft
   */
  public Draft findDraft(UUID metaformId, UUID draftId) throws IOException {
