...
public class MetaformTestBuilderResource extends ApiTestBuilderResource<Metaform, MetaformsApi> {
  ...
  @Override
  public void clean(Metaform metaform) throws IOException {
   ...
   */
  public Metaform create(Metaform payload) throws IOException {
   ...
   */
  public Metaform findMetaform(UUID metaformId, UUID replyId, String ownerKey) throws IOException {
   ...
   */
  public Metaform updateMetaform(UUID id, Metaform body) throws IOException {
   ...
   */
  public Metaform[] list() throws IOException {
   ...
   */
  public void delete(Metaform metaform) throws IOException {
   ...
   */
  public void assertCount(int expected) throws IOException {
   ...
   * @param metaformId     metaform id
   */
  public void assertFindFailStatus(int expectedStatus, UUID metaformId) throws IOException {
   ...
   * @param payload        payload
   */
  public void assertCreateFailStatus(int expectedStatus, Metaform payload) throws IOException {
    try {
   ...
   */
  public void assertUpdateFailStatus(int expectedStatus, UUID metaformId, Metaform metaform) throws IOException {
    try {
   ...
   * @param metaform       metaform
   */
  public void assertDeleteFailStatus(int expectedStatus, Metaform metaform) throws IOException {
    try {
      getApi().deleteMetaform(metaform.getId());
   ...
   * @param expectedStatus expected status code
   */
  public void assertListFailStatus(int expectedStatus) throws IOException {
    try {
