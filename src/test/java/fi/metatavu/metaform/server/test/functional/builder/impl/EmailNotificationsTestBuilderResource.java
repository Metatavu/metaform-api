...
public class EmailNotificationsTestBuilderResource extends ApiTestBuilderResource<EmailNotification, EmailNotificationsApi> {
   ...
   * @return email notification
   */
  public EmailNotification createEmailNotification(UUID metaformId, String subjectTemplate, String contentTemplate, List<String> emails, FieldRule notifyIf) throws IOException {
  ...
  @Override
  public void clean(EmailNotification emailNotification) throws IOException {
   ...
   */
  public EmailNotification findEmailNotification(UUID metaformId, UUID emailNotId) throws IOException {
   ...
   */
  public List<EmailNotification> listEmailNotifications(UUID metaformId) throws IOException {
